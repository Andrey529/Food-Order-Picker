    ...
    fun addBurger(
        ...
        return if ((requestBody == null) || !requestBody.isPresent) {
            ...
            val item: CosmosItemResponse<Burger> =
                container!!.createItem(burger, PartitionKey(Burger::class.java), cosmosItemRequestOptions)
    ...
    fun getBurger(
        ...
        if (id != null) {
            try {
                ...
                if (container != null) {
                    val item: CosmosItemResponse<Burger> = container!!.readItem(id, PartitionKey(Burger::class.java), Burger::class.java)
