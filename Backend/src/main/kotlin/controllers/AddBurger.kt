    ...
    fun addBurger(
        ...
        return if ((requestBody == null) || !requestBody.isPresent) {
            ...
            val item: CosmosItemResponse<Burger> =
                container!!.createItem(burger, PartitionKey(burger.id.toString()), cosmosItemRequestOptions)
    ...
    fun getBurger(
        ...
        if (id != null) {
            try {
                ...
                if (container != null) {
                    val item: CosmosItemResponse<Burger> = container!!.readItem(id, PartitionKey(id.toString()), Burger::class.java)
